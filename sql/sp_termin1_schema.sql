...
ALTER TABLE public.capaian ADD COLUMN IF NOT EXISTS capaian1_g3 INTEGER DEFAULT 0;
ALTER TABLE public.capaian ADD COLUMN IF NOT EXISTS capaian1_pml_g3 INTEGER DEFAULT 0;
